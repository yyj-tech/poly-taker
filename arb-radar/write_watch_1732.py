#!/usr/bin/env python3
"""Write watch-jdg-tt.md/json for 2026-08-21 ~17:32 CST vs 16:34. Analysis only."""
...
# 429: reuse 16:34 TT vs LGD prematch quotes with †. JDG ended → keep — (do not reuse).
STALE_1634_LGD = {
    "stake_a": 1.92,
    "stake_b": 1.88,
    "duel_a": 1.93,
...
# baseline 16:34 values
base_pm_tt, base_pm_lgd = 0.51, 0.52
base_stake_tt, base_stake_lgd = 1.92, 1.88
base_duel_tt, base_duel_lgd = 1.93, 1.93
base_sz_tt, base_sz_lgd = 2195.45, 692.86
base_rates = {
    "duel_tt": -0.04271805,  # Duel buy TT
    "stake_tt": -0.04518466,
    "duel_lgd": -0.03335614,
    "stake_lgd": -0.04606308,
}
base_best = -0.03335614
...
payload = {
    ...
    "vs_1634": {
        ...
        "lgd_l1_size_delta": round((s_b_lgd or 0) - 692.86, 2),
        "tt_l1_size_delta": round((s_a_tt or 0) - 2195.45, 2),
    },
    "table1": [
        {
            "状态": "结束",
