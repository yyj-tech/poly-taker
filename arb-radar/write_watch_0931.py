#!/usr/bin/env python3
"""Write watch-jdg-tt.md/json for 2026-08-22 ~09:31 CST vs 22:32. Analysis only."""
...
payload = {
    ...
    "vs_2232": {
        ...
        "lgd_l1_size_delta": round((s_b_lgd or 0) - 546.46, 2),
        "tt_l1_size_delta": round((s_a_tt or 0) - 102.07, 2),
    },
    "table1": [
        {
            "状态": "结束",
