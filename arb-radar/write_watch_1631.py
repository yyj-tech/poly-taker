#!/usr/bin/env python3
"""Write watch-jdg-tt.md/json for 2026-08-21 ~16:31 CST vs 15:33. Analysis only."""
...
base_sz_tt, base_sz_lgd = 317.7, 2960.6
base_rates = {
...
payload = {
    ...
    "vs_1533": {
        ...
        "lgd_l1_size_delta": round((s_b_lgd or 0) - 2960.58, 2),
        "tt_l1_size_delta": round((s_a_tt or 0) - 317.73, 2),
    },
    "table1": [
        {
            "状态": "结束",
