#!/usr/bin/env python3
"""Write watch-jdg-tt.md/json for 2026-08-21 ~19:31 CST vs 18:35. Analysis only."""
...
payload = {
    ...
    "vs_1835": {
        ...
        "lgd_l1_size_delta": round((s_b_lgd or 0) - 490.73, 2),
        "tt_l1_size_delta": round((s_a_tt or 0) - 1946.97, 2),
    },
    "table1": [
        {
            "状态": "结束",
