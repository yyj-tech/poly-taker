#!/usr/bin/env python3
"""Write watch-jdg-tt.md/json for 2026-08-22 ~13:31 CST vs 12:31. Analysis only."""
...
base_sz_tt, base_sz_lgd = 1477.77, 14.54
base_rates = {
...
for book, r, thick in paths_sorted:
    ...
    if dagger:
        note = ("LPL Duel 429†沿用12:31" if book == "Duel" else "LPL Stake 429†沿用12:31")
...
payload = {
    ...
    "vs_1231": {
        ...
        "lgd_l1_size_delta": round((s_b_lgd or 0) - 14.54, 2),
